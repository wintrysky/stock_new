...
namespace Samples
{
    ...
    public class ContractSamples
    {
        ...
        public static Contract USStockAAPL()
        {
            //! [stkcontract]
            Contract contract = new Contract();
        ...
        // 免费的NEO Exchange，包括Aequitas交易所上交易的TSX和TSXV挂牌股票。
        public static Contract USStockFree()
        {
            //! [stkcontract]
            Contract contract = new Contract();
            contract.Symbol = "BIOV";
            contract.SecType = "STK";
            contract.Currency = "CAD";
            //In the API side, NASDAQ is always defined as ISLAND in the exchange field
            contract.Exchange = "SMART";
            //contract.PrimaryExch = "PURE";
            //! [stkcontract]
            return contract;
        }
        ...
        public static Contract USStockFreeQuery()
        {
            Contract contract = new Contract();
            contract.Symbol = "BIOV";
            contract.SecType = "STK";
