...
namespace Samples
{
    public class Sample
    {
        ...
        {
            //int developmentPort  = 4002;
            int productionPort = 4001;
            ...
            // 开发环境 4002
            // 正式环境 4001
            clientSocket.eConnect("127.0.0.1", productionPort, 0);
            //! [connect]
            //! [ereader]
        ...
        private static void historicalDataRequests(EClientSocket client)
        {
            ...
            client.reqHistoricalData(4001, ContractSamples.USStockFree(), queryTime, "1 Y", "1 day", "MIDPOINT", 1, 1, false, null);
        ...
        private static void contractOperations(EClientSocket client)
        {
            ...
            client.reqContractDetails(214, ContractSamples.USStockFreeQuery());
            //! [reqcontractdetails]

            Thread.Sleep(2000);
            //! [reqmatchingsymbols]
            //client.reqMatchingSymbols(211, "BIOV");//BIOV
            //! [reqmatchingsymbols]
        }
