...
type StockBasic struct {
	...
	Key string `gorm:"column:ikey" json:"key"`
	...
	IncreaseRateCurrDay float64 `gorm:"column:increase_rate_curr_day" json:"increase_rate_curr_day"`
	...
	// 5日交易额涨跌幅
	TradeRate5day float64 `gorm:"column:trade_rate_5day" json:"trade_rate_5day"`
	// 10日交易额涨跌幅
	TradeRate10day float64 `gorm:"column:trade_rate_10day" json:"trade_rate_10day"`
	// 20日交易额涨跌幅
	TradeRate20day float64 `gorm:"column:trade_rate_20day" json:"trade_rate_20day"`
	// 60日交易额涨跌幅
	TradeRate60day float64 `gorm:"column:trade_rate_60day" json:"trade_rate_60day"`
	// 计算交易额涨跌幅的定时任务日期
	TradeRateDate null.Time `gorm:"column:trade_rate_date" json:"trade_rate_date"`
}
